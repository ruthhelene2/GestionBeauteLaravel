...
<!-- Se connecter pour la premier fois et on enregistre -->
<div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    <div>
      <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="Workflow">
      <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">{{config('app.name') }} - Register</h2>
      <!-- <p class="mt-2 text-center text-sm text-gray-600">
        Or
        <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500"> start your 14-day free trial </a>
      </p> -->
    </div>
    <form class="mt-8 space-y-6" action="{{route('postRegister')}}" method="POST">
        @csrf
    ...
    <div class="text-sm font-medium  text-center">
      Already have an account? <a class="underline text-indigo-500" href="{{route('login')}}"> Sign In</a> 
    </div>
  </div>
</div>